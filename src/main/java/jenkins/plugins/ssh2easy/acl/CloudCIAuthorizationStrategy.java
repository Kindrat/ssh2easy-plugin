...
public class CloudCIAuthorizationStrategy extends AuthorizationStrategy {
    ...
    public static final class DescriptorImpl extends GlobalMatrixAuthorizationStrategy.DescriptorImpl {
        ...
        public void doAssignSubmit(StaplerRequest req, StaplerResponse rsp) throws ServletException, IOException {
            ...
            if (json.has(AclType.GLOBAL.getType())
                ...
                for (Map.Entry<AclType, CloudProject> map : maps.entrySet()) {
                    ...
                    JSONObject projects = json.getJSONObject(map.getKey().getType());
        ...
        public AuthorizationStrategy newInstance(StaplerRequest req, JSONObject formData) throws FormException {
            ...
            if (formData.has(AclType.GLOBAL.getType())
                ...
                for (Map.Entry<String, JSONObject> r : (Set<Map.Entry<String, JSONObject>>) projectRoles
                    ...
                    String viewNamePattern = r.getValue().getString(PROJECT_VIEW_NAME_PATTERN);
                    ...
                    String jobNamePattern = r.getValue().getString(PROJECT_JOB_NAME_PATTERN);
                    ...
                    if (roleMap != null) {
                        Set<String> userIds = roleMap.listProjectMembers(roleName);
                        if (userIds != null) {
                ...
                strategy.assignProjectMember(AclType.GLOBAL, adminRole, getCurrentUser());
            }
            return strategy;
        }
        ...
        private Project createAdminRole() {
            ...
            return new Project("admin", permissions);
        }
